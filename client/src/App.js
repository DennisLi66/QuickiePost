      ...
      () => {
        ...
        function changeNavToLoggedIn() {
          changeNavBar( <
            ...
            <
            Nav className = "mr-auto my-2 my-lg-0 container-fluid"
            style = {
              {
                maxHeight: '100px'
              }
            ...
            .then(data => {
              ...
              if (data.status === -2) { //Invalid Combination
                ...
                changeCode( <
                  div >
                  <
                  div className = "errMsg" > There was an error.Please
                  try again. < /div> <
                  form onSubmit = {
                    handleLogin
                  } >
                ...
                cookies.set('expireTime', rememberMe === 'hour' ? Date.now() + 3600000 : "forever", {
                  path: "/"
                })
        ...
        function showUserProfile(userID, startPos = 0, endPos = 10, variation = "") {
              ...
              .then(data => {
                ...
                if (data.status === -2) { //Invalid Combination
                  changeCode( <
                    ...
                    form onSubmit = {
                      (event) => {
                        innerHandleLogin(event, start, end, variation)
                      }
                    } >
                    <
                    h1 > Login Page < /h1> <
          ...
          function innerLoginPage(username, start, end, variation) {
            changeCode( <
              ...
              Button onClick = {
                () => {
                  cancel(username, start, end, variation)
                }
              } > Cancel < /Button> <
              br > < /br> <
              form onSubmit = {
              ...
              .then(data => {
                  ...
                  for (let i = firstPoint; i < Math.min(secondPoint, data.blockedUsers.length); i++) {
                    listOfBlockedUsers1.push( <
                      ...
                      <
                      td > {
                        data.blockedUsers[i].username
                      } < /td> <
                      td > < Button onClick = {
                        () => {
                          showUserProfile(data.blockedUsers[i].userID)
                        }
                      } > View Profile < /Button></td >
                      <
                      td > < Button onClick = {
                        () => {
                          unblockUser("blockMenu", firstPoint, secondPoint, data.blockedUsers[i].userID)
                        }
                    ...
                    if (data.blockedUsers.length > 10) {
                      ...
                      for (let i = 0; i < Math.ceil(data.blockedUsers.length / 10); i++) {
                        paginationSlots.push(
                          ...
                          onClick = {
                            () => {
                              showBlockedList(10 * i + 1, Math.min(10 * i + 10, data.blockedUsers.length))
                            }
                          } > {
                            10 * i + 1
                          }
                          through {
                            Math.min(10 * i + 10, data.blockedUsers.length)
                          } < /div></li >
                        )
                      }
                      paginationBar = ( <
                        ...
                        href = "#"
                        role = "button"
                        aria - expanded = "false" > Users Range < /div> <
                ...
                .then(data => {
                    ...
                    for (let i = firstPoint; i < Math.min(secondPoint, data.listOfToView.length); i++) {
                      listOfUsers.push( <
                        ...
                        td > < Button onClick = {
                          () => {
                            showUserProfile(data.listOfToView[i].userID)
                          }
                        } > View Profile < /Button></td >
                        <
                        td > < Button onClick = {
                          () => {
                            removeViewership(data.listOfToView[i].userID, cookies.get('id'), firstPoint, secondPoint, "imviewing")
                          }
                        } > Stop Viewing User < /Button></td >
                        <
                        /tr>
                      )
                    }
                      ...
                      if (data.listOfToView.length > 10) {
                        ...
                        for (let i = 0; i < Math.ceil(data.listOfToView.length / 10); i++) {
                          paginationSlots.push(
                            ...
                            onClick = {
                              () => {
                                showPeopleImViewing(10 * i + 1, Math.min(10 * i + 10, data.listOfToView.length))
                              }
                            } > {
                              10 * i + 1
                            }
                            through {
                              Math.min(10 * i + 10, data.listOfToView.length)
                            } < /div></li >
                          )
                        }
                        paginationBar = ( <
                  ...
                  .then(data => {
                      ...
                      for (let i = firstPoint; i < Math.min(secondPoint, data.listOfToView.length); i++) {
                        listOfUsers.push( <
                          ...
                          td > < Button onClick = {
                            () => {
                              removeViewership()(cookies.get('id'), data.listOfToView[i].userID, firstPoint, secondPoint, "viewingme")
                            }
                          } > Stop Viewing User < /Button></td >
                          <
                          /tr>
                        ...
                        if (data.listOfToView.length > 10) {
                          ...
                          for (let i = 0; i < Math.ceil(data.listOfToView.length / 10); i++) {
                            paginationSlots.push(
                              ...
                              onClick = {
                                () => {
                                  showPeopleViewingMe(10 * i + 1, Math.min(10 * i + 10, data.listOfToView.length))
                                }
                              } > {
                                10 * i + 1
                              }
                    ...
                    if (cookies.get('id') === userID) { //isowner
                      ...
                      if (variation === "privacyChanged") {
                        ...
                        optionsMenu = ( <
                          ...
                          } > View List Of People You 're Viewing</Button> <
                          br > < /br> <
                          Button onClick = {
                            () => {
                              showPeopleViewingMe()
                            }
                          } > View List Of People Who Are Viewing You < /Button> <
                          br > < /br> <
                          Button onClick = {
                            () => {
                              showPrivacyTogglePage()
                            }
                          } > Change Your Visibility < /Button> <
                          br > < /br> <
                          Button onClick = {
                            () => {
                              showDeactivationPage()
                            }
                        ...
                        changeCode( <
                          ...
                          onClick = {
                            () => {
                              showPosts(username, posts, 0, 10, comments)
                            }
                          } > {
                            username
                          }
                          ...
                          onClick = {
                            () => {
                              showComments(username, comments, 0, 10, posts)
                            }
                          } > {
                            username
                          }
                          ...
                          onClick = {
                            () => {
                              showOptions(username, posts, comments)
                            }
                          } > Options < /div> <
                          /li> <
                          /ul> {
                        ...
                        fetch(serverLocation + "/relationship?sessionID=" + cookies.get("sessionID") + "&userID=" + cookies.get("id") + "&profileID=" + userID)
                          .then(response => response.json())
                          .then(data => {
                              var blockButton = ( < Button variant = 'danger'
                                  onClick = {
                                    blockUser
                                  } > Block User < /Button>);
                                  if (data.blockingThem && data.blockingThem === 'true') {
                                    blockButton = ( < Button variant = 'danger'
                                      onClick = {
                                        unblockUser
                                      } > Unblock User < /Button>)
                                    }
                                    var requestViewershipButton = ( < Button variant = 'info'
                                        onClick = {
                                          viewershipRequest(userID, cookies.get('id'), "poster")
                                        } > Request Viewership < /Button>);
                                        if (data.viewingThem && data.viewingThem === 'true') {
                                          requestViewershipButton = ( < Button variant = 'info'
                                            onClick = {
                                              () => {
                                                removeViewership(userID, cookies.get("id"), 0, 10, "stopViewership")
                                              }
                                            } > Stop Viewing This User < /Button>)
                                          }
                                              ...
                                              requestViewershipButton = ( < div > Since this user is blocking you, you may not interact with viewership between you and this user. < /div>)
                                                ...
                                                requestViewershipButton =
                                                  ( <
                                                    ...
                                                    Button onClick = {
                                                      () => {
                                                        cancelViewershipRequest(userID, cookies.get('id'), "profile")
                                                      }
                                                    } > Deny Request < /Button> <
                                                    br > < /br> <
                                                    /div>
                                                ...
                                                var conferViewershipButton = ( < Button variant = 'info'
                                                  onClick = {
                                                    () => {
                                                      viewershipRequest(cookies.get('id'), userID, "poster")
                                                    }
                                                  } > Confer Viewership < /Button>);
                                                  if (data.viewingMe && data.viewingMe === "true") {
                                                    conferViewershipButton = ( < Button variant = 'info'
                                                      onClick = {
                                                        () => {
                                                          removeViewership(cookies.get("id"), userID, 0, 10, "stopViewingMe")
                                                        }
                                                      } > Remove User 's Viewership Of You</Button>);
                                                    }
                                                    else if (data.blockingThem && data.blockingThem === 'true') {
                                                      conferViewershipButton = ( < div > Since you are blocking them, you may not interact with viewership between you and this user. < /div>);
                                                        ...
                                                        conferViewershipButton = ( < div > Since this user is blocking you, you may not interact with viewership between you and this user. < /div>);
                                                          ...
                                                          conferViewershipButton =
                                                            ( <
                                                              div >
                                                              This user has sent you a viewership request
                                                              for them to view you. <
                                                              br > < /br> <
                                                              Button onClick = {
                                                                () => {
                                                                  viewershipRequest(cookies.get('id'), userID, 'viewer')
                                                                }
                                                              } > Accept Request < /Button> <
                                                              br > < /br> <
                                                              Button onClick = {
                                                                () => {
                                                                  cancelViewershipRequest(cookies.get("id"), userID, "profile")
                                                                }
                                                              } > Deny Request < /Button> <
                                                              br > < /br> <
                                                              /div>
                                                    ...
                                                    optionsMenu = ( <
                                                      ...
                                                      Button onClick = {
                                                        () => {
                                                          innerLoginPage(username, startPos, endPos, 'options')
                                                        }
                                                      } > Login < /Button> <
                                                      /div>
                                                    );
                                                ...
                                                function showComments(username, comments, start, end, posts) {
                                                  ...
                                                  var likeText = ( < Button className = 'likeText'
                                                      onClick = {
                                                        () => {
                                                          innerLoginPage(username, start, end, 'comments')
                                                        }
                                                      } > Like < /Button>);
                                                      for (let i = start; i < (Math.min(end, comments.length)); i++) {
                                                        var dict = comments[i];
                                                        if (cookies.get('sessionID') && cookies.get('id')) {
                                                          likeText = ( < Button className = 'likeText'
                                                            onClick = {
                                                              () => {
                                                                handleCommentLike(comments[i].postID, "userProfile", 0, userID, start, end)
                                                              }
                                                            } > Like < /Button>);
                                                            if (dict.Liked === "Liked") {
                                                              likeText = ( < Button className = 'likeText'
                                                                onClick = {
                                                                  () => {
                                                                    handleCommentUnlike(comments[i].postID, start, end)
                                                                  }
                                                                } > Unlike < /Button>);
                                                              }
                                                            }
                                                          ...
                                                          if (comments.length > 10) {
                                                            ...
                                                            for (let i = 0; i < Math.ceil(comments.length / 10); i++) {
                                                              paginationSlots.push(
                                                                ...
                                                                onClick = {
                                                                  () => {
                                                                    showComments(username, comments, 10 * i + 1, Math.min(10 * i + 10, comments.length), posts)
                                                                  }
                                                                } > {
                                                                  10 * i + 1
                                                                }
                                                                through {
                                                                  Math.min(10 * i + 10, comments.length)
                                                                } < /div></li >
                                                              )
                                                            }
                                                            paginationBar = ( <
                                                              ...
                                                              href = "#"
                                                              role = "button"
                                                              aria - expanded = "false" > Comments Range < /div> <
                                                              ul className = "dropdown-menu" > {
                                                                paginationSlots
                                                              } <
                                                              /ul> <
                                                          ...
                                                          if (listOfShownComments.length === 0) {
                                                            ...
                                                            changeCode( <
                                                              ...
                                                              /li> <
                                                              /ul> <
                                                              div className = 'centerAlignPaginationBar' > {
                                                                paginationBar
                                                              } < /div> <
                                                          ...
                                                          function showPosts(username, posts, start, end, comments) {
                                                            ...
                                                            for (let i = start; i < (Math.min(end, posts.length)); i++) {
                                                              ...
                                                              var likeText = ( < Button className = 'likeText'
                                                                  onClick = {
                                                                    () => {
                                                                      innerLoginPage(username, start, end, 'posts')
                                                                    }
                                                                  } > Like < /Button>);
                                                                  if (detect) {
                                                                    likeText = ( < Button className = 'likeText'
                                                                      onClick = {
                                                                        () => {
                                                                          handlePostLike(posts[i].postID, "userProfile", 0, userID, startPos, endPos)
                                                                        }
                                                                      } > Like < /Button>);
                                                                      if (dict.isLiked === "Liked") {
                                                                        likeText = ( < Button className = 'likeText'
                                                                          onClick = {
                                                                            () => {
                                                                              handlePostUnlike(posts[i].postID, "userProfile", 0, userID, startPos, endPos)
                                                                            }
                                                                          } > Unlike < /Button>);
                                                                        }
                                                                      }
                                                                    ...
                                                                    if (posts.length > 10) {
                                                                      ...
                                                                      for (let i = 0; i < Math.ceil(posts.length / 10); i++) {
                                                                        paginationSlots.push( <
                                                                          ...
                                                                          onClick = {
                                                                            () => {
                                                                              showPosts(username, posts, 10 * i + 1, Math.min(10 * i + 10, posts.length), comments)
                                                                            }
                                                                          } > {
                                                                            10 * i + 1
                                                                          }
                                                                          through {
                                                                            Math.min(10 * i + 10, posts.length)
                                                                          } < /div></li >
                                                                        )
                                                                      }
                                                                      paginationBar = ( <
                                                                        ...
                                                                        href = "#"
                                                                        role = "button"
                                                                        aria - expanded = "false" > Posts Range < /div> <
                                                                        ul className = "dropdown-menu" > {
                                                                          paginationSlots
                                                                        } <
                                                                        /ul> <
                                                                    ...
                                                                    if (listOfShownPosts.length === 0) {
                                                                      ...
                                                                      changeCode( <
                                                                        ...
                                                                        onClick = {
                                                                          () => {
                                                                            showPosts(username, posts, start, end, comments)
                                                                          }
                                                                        } > {
                                                                          username
                                                                        }
                                                                          ...
                                                                          .then(data => {
                                                                            ...
                                                                            if (data.postLiked && data.postLiked === "Liked") {
                                                                              likePostButton = ( <
                                                                                Button onClick = {
                                                                                  () => {
                                                                                    handlePostUnlike(data.postID, "indepthComment", commentID)
                                                                                  }
                                                                                } > Unlike < /Button>
                                                                              )
                                                                              ...
                                                                              likePostButton = ( <
                                                                                Button onClick = {
                                                                                  () => {
                                                                                    handlePostLike(data.postID, "indepthComment", commentID)
                                                                                  }
                                                                                } > Like < /Button>
                                                                              )
                                                                            }
                                                                            var likeCommentButton = ( <
                                                                              Button onClick = {
                                                                                () => {
                                                                                  handleCommentLike(data.commentID, "indepthComment")
                                                                                }
                                                                              } > Like < /Button>
                                                                            );
                                                                            if (data.commentLiked && data.commentLiked === "Liked") {
                                                                              likeCommentButton = ( <
                                                                                Button onClick = {
                                                                                  () => {
                                                                                    handleCommentUnlike(data.commentID, "", "")
                                                                                  }
                                                                                } > Unlike < /Button>
                                                                              )
                                                                            ...
                                                                            if (data.commenterID === cookies.get("id")) {
                                                                              editButton = ( <
                                                                                ...
                                                                                Button onClick = {
                                                                                  () => {
                                                                                    showEditComment(data.commentVisibility, data.comment)
                                                                                  }
                                                                                } > Edit Comment < /Button> <
                                                                                /Card.Body>
                                                                              )
                                                                            ...
                                                                            changeCode( <
                                                                              ...
                                                                              Card.Subtitle > {
                                                                                "Username: " + data.posterUsername
                                                                              } < /Card.Subtitle> <
                                                                              Card.Subtitle > {
                                                                                "User ID: " + data.posterID
                                                                              } < /Card.Subtitle> <
                                                                              Card.Body > {
                                                                                data.content
                                                                              } < /Card.Body> <
                                                                          ...
                                                                          .then(data => {
                                                                              if (data.status === -1) {
                                                                                ...
                                                                                for (let key = commentStart; key < Math.min(data.comments.length, commentEnd); key++) {
                                                                                  ...
                                                                                  var likeButton = ( < Button onClick = {
                                                                                        () => {
                                                                                          displayInnerLogin()
                                                                                        }
                                                                                      } > Like < /Button>);
                                                                                      if (detect) {
                                                                                        likeButton = ( < Button onClick = {
                                                                                            () => handleCommentLike(data.comments[key].commentID, "indepthComment", postID, 0, commentStart, commentEnd)
                                                                                          } > Like < /Button>);
                                                                                          if (comment.commentLiked && comment.commentLiked === "Liked") {
                                                                                            likeButton = ( < Button onClick = {
                                                                                                () => handleCommentUnlike(data.comments[key].commentID)
                                                                                              } > Unlike < /Button>)
                                                                                            }
                                                                                          }
                                                                                          listOfComments.push( <
                                                                                            ...
                                                                                            Card >
                                                                                            <
                                                                                            Card.Header > < div className = 'linkText'
                                                                                            onClick = {
                                                                                              () => {
                                                                                                showUserProfile(data.comments[key].commenterID)
                                                                                              }
                                                                                            } > {
                                                                                            ...
                                                                                            Card.Body > < div className = "linkText"
                                                                                            onClick = {
                                                                                              () => {
                                                                                                showInDepthComment(data.comments[key].commentID)
                                                                                              }
                                                                                            } > {
                                                                                              comment.comments
                                                                                            } < /div> </Card.Body >
                                                                                          ...
                                                                                          if (data.comments.length > 10) {
                                                                                            ...
                                                                                            for (let i = 0; i < Math.ceil(data.comments.length / 10); i++) {
                                                                                              paginationSlots.push(
                                                                                                ...
                                                                                                onClick = {
                                                                                                  () => {
                                                                                                    showInDepthPost(postID, 10 * i + 1, Math.min(10 * i + 10, data.comments.length))
                                                                                                  }
                                                                                                } > {
                                                                                                  10 * i + 1
                                                                                                }
                                                                                                through {
                                                                                                  Math.min(10 * i + 10, data.comments.length)
                                                                                                } < /div></li >
                                                                                              )
                                                                                            }
                                                                                            paginationBar = ( <
                                                                                            ...
                                                                                            var postLikedText = ( < Button onClick = {
                                                                                                  () => {
                                                                                                    displayInnerLogin()
                                                                                                  }
                                                                                                } > Like < /Button>);;
                                                                                                if (detect) {
                                                                                                  postLikedText = ( < Button onClick = {
                                                                                                        () => {
                                                                                                          handlePostLike(data.postID, "indepthPost")
                                                                                                        }
                                                                                                      } > Like < /Button>);
                                                                                                      if (data.likedPost && data.likedPost === "Liked") {
                                                                                                        postLikedText = ( < Button onClick = {
                                                                                                            () => {
                                                                                                              handlePostUnlike(data.postID, "indepthPost")
                                                                                                            }
                                                                                                          } > Unlike < /Button>)
                                                                                                        }
                                                                                                      }
                                                                                                      var writeCommentButton = ( < Button onClick = {
                                                                                                          () => {
                                                                                                            displayInnerLogin()
                                                                                                          }
                                                                                                        } > Add Comment < /Button>);
                                                                                                        if (detect) {
                                                                                                          writeCommentButton = ( < Button onClick = {
                                                                                                              () => {
                                                                                                                displayCommentWriter()
                                                                                                              }
                                                                                                            } > Add Comment < /Button>)
                                                                                                          ...
                                                                                                          var confrimation = ( < div > < /div>);
                                                                                                            if (pact && pact === 'Add') {
                                                                                                              ...
                                                                                                              changeInDepthCode( <
                                                                                                                Card >
                                                                                                                <
                                                                                                                Card.Header className = 'rightAlignHeader' > < Button onClick = {
                                                                                                                  closeInDepthPost
                                                                                                                ...
                                                                                                                onClick = {
                                                                                                                  () => {
                                                                                                                    showUserProfile(data.authorID)
                                                                                                                  }
                                                                                                                } > Author: {
                                                                                                                  data.authorName
                                                                                                                } < /div> Date Written: {data.postDate} <
                                                                                                                br > < /br>
                                                                                                                Likes: {
                                                                                                                  data.totalLikes
                                                                                                                } <
                                                                                                        ...
                                                                                                        function getMyPosts() { //change visibility possible here
                                                                                                          ...
                                                                                                          fetch(serverLocation + "/user?userID=" + cookies.get("id"))
                                                                                                            ...
                                                                                                            .then(data => {
                                                                                                              ...
                                                                                                              if (listOfPosts.length === 0) {
                                                                                                                listOfPosts = ( <
                                                                                                                  div > You either haven 't written any posts, or they'
                                                                                                                  ve all been deleted. < /div>
                                                                                                                )
                                                                                                              }
                                                                                                              changeCode( <
                                                                                                                div >
